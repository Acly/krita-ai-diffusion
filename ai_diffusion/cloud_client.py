...
models.resources = {
    ...
    resource_id(ResourceKind.controlnet, SDVersion.sdxl, ControlMode.segmentation): None,
    ...
    resource_id(ResourceKind.controlnet, SDVersion.sdxl, ControlMode.blur):"xinsir-controlnet-tile-sdxl-1.0.safetensors",
