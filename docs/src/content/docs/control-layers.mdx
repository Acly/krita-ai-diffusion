...
The control image broadly influences the generated image.
...
of a face. It's best not to crop too closely, a bit of padding is fine. This mode
works when you select the area in the canvas where you want the face to appear, or
when generating a person somewhere in the image.
