...
To create a region, use the <Icon name="region-add-dark" /> button next to the text input.
...
<Icon name="remove-dark" /> button - this will remove the associated text, but keep the layer. A
region can also be <Icon name="link-dark" /> linked and unlinked from the active layer.
...
The text input at the very bottom is reserved for the <Icon name="root-dark" />
Root prompt. It is not linked to any layer. It should describe the general
...
* <Icon name="control-reference-dark" /> Reference
* <Icon name="control-composition-dark" /> Composition
* <Icon name="control-style-dark" /> Style
* <Icon name="control-face-dark" /> Face
...
2. Click <Icon name="region-add-dark" /> Create region. This will transform the existing "Background"
   layer into a region. By default it's white and fully opaque. Fill in some
   text that describes things in the background.
3. Click <Icon name="region-add-dark" /> Create region again. This creates a new layer group with a
...
6. Click <Icon name="generate-dark" /> Generate!
</Steps>
...
3. Click <Icon name="region-add-dark" /> Create region. Fill in some text that describes things in the background.
...
5. With the subject layer active, <Icon name="region-add-dark" /> create a new region. Fill in some text
...
3. After you have a decent first draft background, <Icon name="apply-dark" /> apply it. In live mode this
   will overwrite existing layer content by default.
4. Click <Icon name="region-add-dark" /> Create region. This will create a new paint layer. Fill in some
...
layers. To make this workflow easier there is the <Icon name="region-alpha-dark" /> Refine region toggle.
