...
* <PluginIcon name="control-reference" text="Reference" /> 
* <PluginIcon name="control-composition" text="Composition" /> 
* <PluginIcon name="control-style" text="Style"/> 
* <PluginIcon name="control-face" text="Face" /> 
