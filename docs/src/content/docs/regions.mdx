...
To create a region, use the <PluginIcon name="region-add" /> button next to the text input.
...
The text input at the very bottom is reserved for the <PluginIcon name="root" />
...
* <PluginIcon name="control-reference" /> Reference
* <PluginIcon name="control-composition" /> Composition
* <PluginIcon name="control-style" /> Style
* <PluginIcon name="control-face" /> Face
...
2. Click <PluginIcon name="region-add" /> Create region. This will transform the existing "Background"
   layer into a region. By default it's white and fully opaque. Fill in some
   text that describes things in the background.
3. Click <PluginIcon name="region-add" /> Create region again. This creates a new layer group with a
...
6. Click <PluginIcon name="generate" /> Generate!
</Steps>
...
3. Click <PluginIcon name="region-add" /> Create region. Fill in some text that describes things in the background.
...
3. After you have a decent first draft background, <PluginIcon name="apply" /> apply it. In live mode this
   will overwrite existing layer content by default.
4. Click <PluginIcon name="region-add" /> Create region. This will create a new paint layer. Fill in some
...
layers. To make this workflow easier there is the <PluginIcon name="region-alpha" /> Refine region toggle.
