...
<div class="front-cards">
	<Card title="Guides">
		...
		- [Editing with Instructions](/edit-models): use text instructions to modify images

		#### Advanced topics
		- [ComfyUI Setup](/comfyui-setup): how to connect a custom ComfyUI installation
		- [Custom Workflows](/custom-graph): create and use your own ComfyUI workflows
		- [Samplers](/samplers): customizing sampling algorithms

		#### Knowledge base
		- [Troubleshooting](/common-issues): common issues and how to fix
		- [Resolutions](/resolutions): how the plugin handles different image sizes
		- [Base Models](/base-models): learn about supported diffusion architectures
		- [Model Databases](/model-databases): download links for supported models
	</Card>
	<div>
