...
1. Hardware requirements
    ...
    <table className="mb-2">
        <tbody>
            ...
            <tr>
                <td><Soft><Icon name="bootstrap/amd" /> AMD</Soft></td>
                <td><Soft>Not supported by managed installation.<br />
                Please <ExternalLink href="https://www.comfy.org/download">install ComfyUI</ExternalLink> separately, then [connect it to the plugin](/comfyui-setup).</Soft></td>
            </tr>
            <tr>
                <td><Soft>CPU</Soft></td>
...
3. Installation
    ...
    2. Choose a backend. CUDA only works for NVIDIA GPUs.
