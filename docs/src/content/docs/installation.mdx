...
1. Make sure you have Krita version **5.2** (or later) installed.
...
2. Download the Plugin
    ...
    <Aside type="note">
    **Krita 5.x**: look for the latest **1.x** release of the plugin.<br/>
    **Krita 6.x**: use the latest **2.x** release of the plugin (coming soon).
    </Aside>
...
5. Configure Image Generation
    ...
    <ImageSample src="installation/server-options.png" alt="Server options" scale="1.5" />
...
6. Connect to Online Service _(Optional)_
    ...
    <ImageSample src="installation/sign-in.png" alt="Sign in" scale="1.5" />
    ...
    <table className="mb-2">
        <tbody>
            <tr>
                ...
                <td>RTX 2060 or better.</td>
            </tr>
            <tr>
                <td><Icon name="bootstrap/apple" /> Apple</td>
                <td>Apple Silicon only (M1-M5).</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>ROCm enabled graphics cards.</td>
            </tr>
            <tr>
                <td><Soft>CPU</Soft></td>
                <td><Soft>Works, but is very slow.</Soft></td>
            </tr>
        </tbody>
    </table>
...
3. Installation
    ...
    2. Choose a backend. CUDA only works for NVIDIA GPUs. ROCm is for AMD, XPU is for Intel.<br />
        <Soft>Make sure to do this _before_ you install!</Soft>
    3. Select workloads to install.<br />
        <Soft>Workloads install a set of recommended models along with your choice. Download and installation size will increase the more models you select.</Soft>
    4. (Optional) Customize packages to install.<br />
        <Soft>The "Individual Packages" tab allows to select/deselect specific models. You can skip this at first and come back later to install additional packages.</Soft>
    5. Click install!
    
    <ImageSample src="installation/local-install.png" alt="Local install" scale="1.5" />
</Steps>
