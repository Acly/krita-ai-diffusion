...
2. Operating System
    ...
    <Hint>
        <Icon name="awesome/linux" /> <Icon name="bootstrap/apple" /> _Linux and macOS users_

        Python with venv must be installed. Recommended version: 3.11 or 3.12.<br />
        This is usually available via package manager, eg. `apt install python3-venv`
    </Hint>
    <Hint>
